...
namespace DoAnTotNghiep.Models.DAO.Admin
{
    public class NguoiDungDAO
    {
        ...
        {
            var list = db.Database.SqlQuery<flatKhachHang>($"SELECT nd.IDNguoiDung, nd.Username, nd.Ten, pl.Ten AS TenLoaiKhachHang, nd.Avatar, nd.SoDonHangDaMua, nd.TongTienHangDaMua, nd.LanHoatDongGanNhat, nd.ModifiedDate " +
                ...
                $"OR nd.ModifiedDate LIKE N'%{searching}%') " +
                $"ORDER BY nd.ModifiedDate DESC").ToList();
